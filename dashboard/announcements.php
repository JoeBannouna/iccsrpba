...
<head>
  ...
  <link id="theme-style" rel="stylesheet" href="/assets/css/main.css?v=1">
...
<?php $announcements = 'active'; include 'header.php'; ?>
  ...
  <script src="/assets/js/main.js?v=1" activeHeaderLink="indexPage" id="main-script"></script>
  <script src="/assets/js/announcements.js?v=1"></script>
